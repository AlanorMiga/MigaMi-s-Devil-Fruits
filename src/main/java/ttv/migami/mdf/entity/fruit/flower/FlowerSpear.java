...
public class FlowerSpear extends SummonEntity implements GeoEntity {
    ...
    public FlowerSpear(LivingEntity owner, Level pLevel, Vec3 blockPos, LivingEntity target, boolean right) {
    ...
    public FlowerSpear(LivingEntity owner, Level pLevel, Vec3 vec3, BlockPos blockPos, boolean right) {
        super(ModEntities.FLOWER_SPEAR.get(), pLevel);
        this.setRight(right);
