...
public class CreeperFruitItem extends FruitItem {

    public CreeperFruitItem(Properties properties) {
        super(properties
                .food(new FoodProperties.Builder()
                        ...
                        .effect(new MobEffectInstance(ModEffects.CREEPER_FRUIT.get(), 360000, 0, false, false), 1.0F)
                        .build()
        ));
    }
