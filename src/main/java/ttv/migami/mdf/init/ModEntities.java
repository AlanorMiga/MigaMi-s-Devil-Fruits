...
public class ModEntities
{
    ...
    public static final RegistryObject<EntityType<GasterBlaster>> GASTER_BLASTER = REGISTER.register("gaster_blaster", () -> EntityType.Builder.<GasterBlaster>of(GasterBlaster::new, MobCategory.MONSTER).sized(1.0F, 1.0F).noSave().noSummon().build("gaster_blaster"));
